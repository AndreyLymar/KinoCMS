...
//            Mail::html($templateHtml, function($message) use ($user) {
//                    $message->from('kinoCms.local@gmail.com', 'Бункер "Свободу пісюнам');
//                    $message->subject('Бункер "Свободу пісюнам"');
//                    $message->to($user->email);
//
//        });
//                             dispatch(new CreateScheduleToUser($user, $templateHtml));
//            }


            return dispatch(new MailingListToUser($users, $templateHtml));
        }
    }
}
