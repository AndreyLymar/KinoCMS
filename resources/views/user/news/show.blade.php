                ...
                @foreach($news->newsGalleries as $key => $newsGallery)
                    <div class="carousel-item {{$key === 0 ? 'active' : ''}}">
                        <img class="bd-placeholder-img" width="100%" height="100%"
                             src="{{Storage::url($newsGallery->img)}}" aria-hidden="true">
        ...
        <div class="row mt-5 mb-5">
            <div class="col-md-9 mb-5 pb-5" style="background-color: #eeeeee;">
                <div class="row mt-5 m-2">
                    <h4 class="fw-light mt-2 text-primary">{{$news->title}}</h4>
                </div>
                <div class="row">
                    <div class="col-md-3 m-2">
                        <img class="mt-5" style="height:auto; width: 300px;"
                             src="{{Storage::url($news->main_img) ?? ''}}" alt="">
                    </div>
